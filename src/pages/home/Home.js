                ...
                <ul className="mt-5">
                  {
                    serviceList[0]?.workList.map((e) => (
                      <li key={e.id} onClick={() => toggleOpen2(e.id)} className={`border rounded-lg px-4 py-4 mb-4 transition-all cursor-pointer ${isOpen2 == e.id ? "border-main-900" : "border-gray-300"}`}>
