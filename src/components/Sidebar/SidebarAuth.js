...
const SidebarAuth = ({ isOpen, toggleOpen }) => {
    ...
    return (
        <>
            <aside id="sidebar" className={`fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 h-[calc(100%-65px)] lg:h-full pt-16 lg:pt-[4.5em] font-normal duration-75 transition-width duration-200 w-full lg:w-64 ${ moOpen ? "flex" : "hidden"} lg:flex`}>
                <div className="relative flex flex-col flex-1 min-h-0 pt-0 bg-white rounded-lg">
                    <div onClick={toggleMoOpen} className=" absolute right-2 top-2 lg:hidden">
                        <IoCloseSharp className="text-xl" />
                    </div>
                    <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                        <div className="flex-1 px-3 divide-y divide-gray-200 ">
                            <ul className="pb-2">
                                <li onClick={() => toggleMoOpen(false)}>
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 bg-white z-10 border-t">
                        ...
                        <div className={`text-sm transition-all overflow-hidden ${isOpens ? "h-0" : "h-36 mt-3"} `} >
                            <p>스마일드래곤주식회사</p>
                            <p>대표 이상필, 문영화</p>
            ...
            <div className="fixed bottom-0 left-0 z-10 bg-white w-full border-t block lg:hidden" >
                <ul className="py-3 flex grid grid-cols-5 gap-2">
                    <li className="flex items-center justify-center flex-col">
                        <Link to="/" className="flex items-center justify-center flex-col">
                            ...
                            <span className={`text-sm mt-1 ${loaction.pathname === '/' ? "text-gray-800" : "text-gray-500"}`}>주문</span>
                        </Link>
                    </li>
                    <li className="flex items-center justify-center flex-col">
                        <Link to="/addfunds" className="flex items-center justify-center flex-col">
                            ...
                            <span className={`text-sm mt-1 ${loaction.pathname === '/addfunds' ? "text-gray-800" : "text-gray-500"}`} >충전</span>
                        </Link>
                    </li>
                    <li className="flex items-center justify-center flex-col">
                        <Link to="/guide" className="flex items-center justify-center flex-col">
                            <FaSearch className={`text-gray-500 text-sm ${loaction.pathname === '/guide' ? "text-gray-800" : "text-gray-500"}`} />
                            <span className={`text-sm mt-1 ${loaction.pathname === '/guide' ? "text-gray-800" : "text-gray-500"}`}>안내</span>
                        </Link>
                    </li>
                    <li className="flex items-center justify-center flex-col">
                        <Link to="/faq" className="flex items-center justify-center flex-col">
                            ...
                            <span className={`text-sm mt-1 ${loaction.pathname === '/faq' ? "text-gray-800" : "text-gray-500"}`} >질문</span>
                        </Link>
                    </li>
                    <li onClick={toggleMoOpen} className="flex items-center justify-center flex-col">
                        ...
                        <span className={`text-sm mt-1 ${moOpen ? "text-gray-800" : "text-gray-500"}`} >메뉴</span>
                    </li>
                </ul>
            </div>
        </>
